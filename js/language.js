...
const translations = {
    "pl": {
        ...
        "AboutDescription1": "Jestem początkującym Cloud & DevOps Engineerem z pasją do AWS, automatyzacji, IaC oraz ciągłej integracji.",
        "AboutDescription2": "Obecnie uczę się Azure oraz Google Cloud Platform, aby poszerzyć swoją wiedzę i umiejętności związane z chmurą.",
        "AboutDescription3": "Moim celem jest automatyzacja i optymalizacja infrastruktury chmurowej oraz procesów.",
        ...
        "TerraformProjectDescription": "Infrastruktura AWS utworzona przy użyciu Terraform.",
    ...
    "eng": {
        ...
        "AboutDescription1": "I'm an aspiring Cloud & DevOps Engineer with a passion for AWS, automation, IaC and continuous integration.",
        "AboutDescription2": "I am currently learning Azure and Google Cloud Platform to expand my cloud expertise.",
        "AboutDescription3": "My goal is to automate and optimize cloud infrastructure and workflows.",
...
function changeLanguage(language) {
    ...
    selectedLanguage && Object.keys(selectedLanguage).forEach(key => {
